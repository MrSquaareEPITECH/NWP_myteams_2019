...
/*
    ...
    character pointer corresponding to the name of the newly created team.
    \param user_id a character pointer corresponding to the name of the user
    who created the team. \return On success, 1 is returned. On error, -1 is
...
/*
    ...
    corresponding to of the user posting the message. \param message a
    character pointer corresponding to the thread's content. \return On
...
/*
    ...
    unique identifier corresponding to the thread hosting the message. \param
    user_id a character pointer corresponding to the universally unique
    identifier corresponding to of the user posting the message. \param message
    a character pointer corresponding to the message's content. \return On
    success, 1 is returned. On error, -1 is returned and errno is set
    appropriately
*/
...
/*
    \param user_id a character pointer corresponding to the universally unique
    identifier corresponding to the newly logged user. \return On success, 1
...
/*
    ...
    unique identifier corresponding to the user sending the message. \param
    receiver_id a character pointer corresponding to the universally unique
    identifier corresponding to the user receiving the message. \param message
    a character pointer corresponding to the message's content. \return On
    success, 1 is returned. On error, -1 is returned and errno is set
    appropriately
*/
